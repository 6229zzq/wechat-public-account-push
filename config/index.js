export const USER_CONFIG = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wx7973cde93d430674",
  
  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "35e531014a77fdb3563573420589298f",
   ...
   */
  USERS: [oTrAy55-fJQd3_e-UcFgZ3iZZwBA
    {
      // 想要发送的人的名字
      name: "箫箫箫箫箫",
      ...
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "vl7lLHCh57_IwK4HXytWM0qo7gA8RaLYv-9VSBb5W-0",
      // 所在省份
      province: "重庆",
      // 所在城市
      city: "重庆",
      ...
      openUrl: "https://www.jianshu.com/p/a18292881789",
  ...
  CALLBACK_TEMPLATE_ID: "vl7lLHCh57_IwK4HXytWM0qo7gA8RaLYv-9VSBb5W-0",
  
  // 接收成功回调消息的微信号，（一般来说只填自己的微信号, name填不填无所谓）
  CALLBACK_USERS: [oTrAy55-fJQd3_e-UcFgZ3iZZwBA
    {
      // 一般都填自己
      name: "自己",
